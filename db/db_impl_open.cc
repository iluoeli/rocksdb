...
Status DBImpl::Open(const DBOptions& db_options, const std::string& dbname,
  ...
  *dbptr = nullptr;
  ...
  DBImpl* impl = nullptr;
  if (db_options.splaying) {
    impl = new DBImplWithSplaying(db_options, dbname, seq_per_batch, batch_per_txn);
  } else {
    impl = new DBImpl(db_options, dbname, seq_per_batch, batch_per_txn);
  }
